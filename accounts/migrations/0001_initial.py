    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_of_student', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('amount_status', models.CharField(blank=True, choices=[('PAID', "to'lagan"), ('NO_PAID', "to'lamagan")], max_length=255, null=True, verbose_name='hisobidagi pul miqdori turi:')),
            ],
            options={
