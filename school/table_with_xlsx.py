import openpyxl
# print("1-A sinf  ".strip() in "1-A sinf")
# bu komputerdagi excel fayl manzili
re = openpyxl.load_workbook('/home/ilyosxon/Asosiy/crm/assets/Ishchi sinflar jadvali 11.09.2023.xlsx')
...
for x in data.values:
  # print(x)
  # if type(x[0])==str and len(x[0].strip())>1 and x[0].strip() in sinf:
  #   print(x[0])
